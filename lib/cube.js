...
Cube.prototype.getCenterSide=function(orient) {
    ...
    Cube.prototype.getEdgeFace=function(edge, orient) {
        var loc = this.getEdgeLocation(edge) % 12;
    ...
    Cube.prototype.getCornerFace=function(corner, orient) {
        var loc = this.getCornerLocation(corner);
...
Cube.prototype.getPartFace=function( part,  orient) {
    {
        if (part < this.cornerLoc.length) {
            return this.getCornerFace(part, orient);
        } else if (part < this.cornerLoc.length + this.edgeLoc.length) {
            return this.getEdgeFace(part - this.cornerLoc.length, orient);
        } else if (part < this.cornerLoc.length + this.edgeLoc.length + this.sideLoc.length) {
            return this.getSideFace(part - this.cornerLoc.length - this.edgeLoc.length);
        } else {
            return this.getCenterSide(orient);
        }
    }
}
...
Cube.prototype.getPartAxis=function( part,  orientation) {
    if (part < this.cornerLoc.length) {
        ...
        // Edge parts
        return this.EDGE_TO_AXIS_MAP[this.getEdgeLocation(part - this.cornerLoc.length) % 12];
    } else if (part < this.cornerLoc.length + this.edgeLoc.length + this.sideLoc.length) {
        // Side parts
        var face = this.getPartFace(part, orientation);
        return (face) % 3;
