...
function includeVirtualRubik(baseURL) {
  ...
  document.write('<script type="text/javascript" src="'+baseURL+'/solver/solver.js"></script>');
  document.write('<script type="text/javascript" src="' + baseURL + '/solver/solverconst.js"></script>');
...
VirtualRubik.prototype.setTwistDuration = function (duration) {
    this.cube3d.attributes.twistDuration = duration;
    time = duration;
}
